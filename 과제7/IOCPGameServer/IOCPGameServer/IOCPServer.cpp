...
void send_packet(int user_id, void* p)
{
	...
	// 메세지 확인부
	//if (buf[1] == SC_PACKET_CHAT)
	//{
	//	cout << reinterpret_cast<sc_packet_chat*>(buf)->message << endl;
	//	cout << "복사전 메세지 -> " << buf[6] << " , " << buf[7] << " , " <<
	//		buf[8] << " , " << buf[9] << " , " << buf[10] << endl;
	//	cout << "보낸 메세지 -> " << exover->io_buf[6] << endl;
	//}
